...
- (void)viewDidLoad {
    ...
    self.typeNormalImages = @[@"type_studyGroup.png", @"type_reviewSession.png", @"type_meeting.png", @"type_infoSession.png",
                            @"type_other.png",@"type_other.png",@"type_other.png",@"type_other.png"];
    self.typeTitles = @[@"StudyGroup", @"Review", @"Partner", @"InfoSession", @"Other",@"Other",@"Other",@"Other"];
...
- (void)changeHeaderImage:(NSInteger)tag {
    switch (tag) {
        ...
        case 3:
            ...
            break;
        case 4:
            self.backgroundImage = [UIImage imageNamed:@"other.png"];
            break;
        default:
            break;
    }
...
- (void)configureTableFooterView {
    ...
    [sureButton setTitle:@"Post" forState:UIControlStateNormal];
