...
- (void) commonSetup {
    _firstSegment = [[VBFDoubleSegment alloc]initWithLength:self.frame.size.width/2
    ...
    _secondSegment = [[VBFDoubleSegment alloc]initWithLength:self.frame.size.width/2
                                                   thickness:self.lineThickness
                                                      radius:self.lineRadius
                                                       color:self.tintColor
                                                initialState:doubleSegmentDefaultState];
    ...
    _thirdSegment = [[VBFDoubleSegment alloc]initWithLength:self.frame.size.width/2
                                                  thickness:self.lineThickness
                                                     radius:self.lineRadius
                                                      color:self.tintColor
