...
#define TUTORIAL_TITLE_FONT                     [UIFont fontWithName:@"CourierNewPS-BoldMT" size:17.0f]
#define TUTORIAL_TITLE_LINES_NUMBER             1
#define TUTORIAL_TITLE_OFFSET                   150
#define TUTORIAL_SUB_TITLE_FONT                 [UIFont fontWithName:@"CourierNewPS-BoldMT" size:17.0f]
